...
void AXmlResourceParser::open(char * stream)
{
	close();
	if (stream != nullptr) {
...
void AXmlResourceParser::close()
{
	...
	delete m_resourceIDs;
	m_resourceIDs = nullptr;
...
int AXmlResourceParser::nextToken()
{
	return next();
}

int AXmlResourceParser::nextTag()
{
	int eventType = next();
...
std::string AXmlResourceParser::nextText()
{
...
void AXmlResourceParser::require(int type, std::string _namespace, std::string name)
{
	if (type != getEventType() ||
		(_namespace != "" && !(_namespace == getNamespace())) ||
		(name != "" && !(name == getName())))
	{
...
int AXmlResourceParser::getDepth()
{
	return m_namespaces->getDepth() - 1;
}

int AXmlResourceParser::getEventType()
{
	return m_event;
}

int AXmlResourceParser::getLineNumber() 
{
	return m_lineNumber;
}

std::string AXmlResourceParser::getName() 
{
...
std::string AXmlResourceParser::getText()
{
...
const char * AXmlResourceParser::getTextCharacters(int holderForStartAndLength[])
{
	...
	text.copy(chars, 0, text.length());
	std::string temp(chars);
	delete chars;
	return temp.c_str();
}

std::string AXmlResourceParser::getNamespace()
{
	return m_strings->getString(this->m_namespaceUri);
}

std::string AXmlResourceParser::getPrefix()
{
	int prefix = m_namespaces->findPrefix(this->m_namespaceUri);
	return m_strings->getString(prefix);
}

std::string AXmlResourceParser::getPositionDescription()
{
	return "XML line #" + getLineNumber();
}

int AXmlResourceParser::getNamespaceCount(int depth)
{
	return m_namespaces->getAccumulatedCount(depth);
}

std::string AXmlResourceParser::getNamespacePrefix(int pos)
{
	int prefix = m_namespaces->getPrefix(pos);
	return m_strings->getString(prefix);
}

std::string AXmlResourceParser::getNamespaceUri(int pos)
{
...
/////////////////////////////////// attributes
std::string AXmlResourceParser::getClassAttribute()
{
...
std::string AXmlResourceParser::getIdAttribute()
{
	if (m_idAttribute == -1) {
		return "";
	}
...
int AXmlResourceParser::getStyleAttribute()
{
	if (m_idAttribute == -1) {
		return NULL;
	}
...
int AXmlResourceParser::getAttributeCount()
{
...
std::string AXmlResourceParser::getAttributeNamespace(int index)
{
	int offset = getAttributeOffset(index);
	int _namespace = m_attributes[offset + ATTRIBUTE_IX_NAMESPACE_URI];
	if (_namespace == -1) {
		return "";
	}
	return m_strings->getString(_namespace);
}

std::string AXmlResourceParser::getAttributePrefix(int index)
{
	int offset = getAttributeOffset(index);
...
std::string AXmlResourceParser::getAttributeName(int index)
{
	int offset = getAttributeOffset(index);
...
int AXmlResourceParser::getAttributeNameResource(int index)
{
	int offset = getAttributeOffset(index);
	int name = m_attributes[offset + ATTRIBUTE_IX_NAME];
	if (m_resourceIDs == nullptr ||
